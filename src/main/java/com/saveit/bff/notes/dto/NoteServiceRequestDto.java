...
public record NoteServiceRequestDto(@NotBlank String noteId, @NotBlank String userId, String title, @NotBlank String content,
                                    @NotBlank NoteSource source, @NotBlank NoteStatus status, @NotBlank NotePriority priority,
                                    Set<TagDto> tags) {}
